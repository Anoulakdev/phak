...
$url = 'http://localhost/phak/voting12';

$apimember = $url . '/api/member.php';
$apimemberdelete = $url . '/api/memberdelete.php';
$apireason = $url . '/api/reason.php';
$apincheck = $url . '/api/ncheck.php';
